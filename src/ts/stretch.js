...
const initStretch = () => {
    const title = document.querySelector('#stretch-title');
    const button = document.querySelector('#stretch-button');
    const timeElement = document.querySelector('#stretch-time');
    const innerElement = document.querySelector('#stretch-inner-circle');
    const outerElement = document.querySelector('#stretch-outer-circle');
    const repDashElements = document.querySelectorAll('.stretch__rep__dashes__dash');
    const setDashElements = document.querySelectorAll('.stretch__set__dashes__dash');
    const soundTimes = {
        1: [23847, 406],
        2: [25066, 464],
        3: [26215, 430],
    ...
    const promisePlay = (sound) => new Promise((res, rej) => {
    ...
    setInterval(() => {
        if (!lastStepTimestamp) {
            ...
            const stepCount = Math.round((Date.now() - lastStepTimestamp) / stepDurationMs);
